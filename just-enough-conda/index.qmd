...
I can ask _where_ the program is installed.
...
However, _I have other computational environments on my computer._
...
- You want to [prevent software upgrades from breaking your code](https://bsky.app/profile/andrewbaker.bsky.social/post/3llz3z7kjvs22), so you want to specify _which_ version of a package you need for this project.
